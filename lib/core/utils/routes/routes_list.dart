...
const String SIGN_IN_VERIFICATION_ROUTE = '/sign-in/verification';
...
const String DUMMY_CAMERA_VIEW_ROUTE =
    '/identity-verification/dummy-camera-view';
...
const String RED_ALERT_ROUTE = '/red-alert-page';
